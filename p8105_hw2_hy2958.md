...
In the tidy data, 10450 observations are included with 149 unique zip
codes and 43 unique neighborhoods. It include variables indicate the
location such as zip_code, county, neighborhood as well as the date and
the Zillow Observed Rent Index which shows the rental price.

There are 171 zip codes appear in the zipcode but didn’t included in the
Zillow Rental Price dataset which can be shown in the missing_zips data.
They may be excluded because the missing value of neighborhood such as
data for zipcode==10499, 10550.
...
The largest rental price drop from 2020.01 to 2021.01 are mostly
concentrated in New York County and within the lower Manhattan, Lower
East Side, Gramercy Park and Murray Hill, Chelsea and Clinton and
Greenwich Village and Soho. The largest drop is 912.5966 which is in
lower Manhattan, New York, 10007.
